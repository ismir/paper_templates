...
% ------
\def\papertitle{Paper template for ISMIR \conferenceyear}


\usepackage[%
% lbd % Option to typeset late-breaking demo extended abstracts
]{ismir}
...
\ifdefined\lbd
Late-Breaking Demo papers may have a maximum of 2 pages. Please note that extended abstract is not a conference paper. Therefore, it will not be part of the official ISMIR \conferenceyear\ proceedings, and should not be cited as such.
\else
...
% \newblock Montr\'{e}al, Canada: McGill-Queen's University Press, 2020.
%
% \bibitem{Person:09}
