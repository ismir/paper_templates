...
We adopt a ``(6+citation)-page policy'' for ISMIR 2017. This means, the total length of the paper is unlimited, however, the technical content including figures, acknowledgement, and possible references must fit into the first 6 pages, and the extra pages can only be used for references. Note that this is a strict requirement. \textcolor{red}{Pages beyond the 6th page, if used at all, must not contain any other material except for references.}
