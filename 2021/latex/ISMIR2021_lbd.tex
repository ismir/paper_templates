...
We adopt a ``(2+n)-page policy'' for Late-Breaking Demo (LBD) papers in ISMIR 2021. That is, LBD papers are extended abstracts that may have a maximum of 2 pages of technical content (including figures and tables) \textcolor{red}{with additional optional pages that contain only references and acknowledgments.} 
