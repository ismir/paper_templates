...
We adopt a ``(2+1)-page policy'' for Late-Breaking Demo (LBD) papers in ISMIR 2021. That is, LBD papers are extended abstracts that may have a maximum of 2 pages of technical content (including figures and tables) \textcolor{red}{with one optional page that contains only references and acknowledgments.} 
...
Line numbers should be included in your originally submitted manuscript, for reference during screening. \textcolor{red}{However, after your extended abstract is accepted, you must remove all line numbers from the final camera-ready version.} This can be done in \LaTeX by commenting out the command \verb|\linenumbers| on Line 22. This can be done in Microsoft Word by selecting Layout > Line Numbers > None.
