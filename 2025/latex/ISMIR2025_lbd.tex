...
\SetWatermarkText{Late-Breaking / Demo Session Extended Abstract, ISMIR 2025 Conference}
...
% ------
\title{Paper template for ISMIR \conferenceyear\ LBD}
...
This template includes all the information about formatting Late-Breaking Demo manuscripts for the ISMIR \conferenceyear\ Conference. Please follow these guidelines to give the final proceedings a uniform look. Most of the required formatting is achieved automatically by using the supplied
...
It is set in 8pt Times. \textcolor{red}{Please ensure to insert the correct author names and paper title in the copyright notice when submitting the manuscript.} For \LaTeX users, this will be handled by the template automatically. For Word users, this has to be done manually.
...
\textcolor{red}{Line numbers should be removed} from your originally submitted manuscript. This can be done in \LaTeX by commenting out the command \verb|\linenumbers|. This can be done in Microsoft Word by selecting Layout > Line Numbers > None.
...
\begin{figure}
 \centerline{\framebox{
 \includegraphics[alt={ISMIR 2025 LBD template test image},width=0.9\columnwidth]{example.png}}}
